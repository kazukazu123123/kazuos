...
pub const SYS_SIGKILL:       u64 = 15;
pub const SYS_SIGTERM:       u64 = 16;
pub const SIGNAL_SIGINT:     u64 = 1;
pub const SIGNAL_SIGTERM:    u64 = 2;
pub const SYS_WAIT:          u64 = 17;
pub const SYS_PROCESS_INFO:  u64 = 18;
pub const SYS_PROCESS_NEXT:  u64 = 19;
pub const SYS_SLEEP:         u64 = 20;
pub const SLEEP_UNIT_MS:     u64 = 0;
pub const SLEEP_UNIT_US:     u64 = 1;
pub const SLEEP_UNIT_TICK:   u64 = 2;

// Memory
pub const SYS_MEM_INFO:   u64 = 21;
pub const SYS_HEAP_ALLOC: u64 = 22;
pub const SYS_HEAP_FREE:  u64 = 23;

// Signals
pub const SYS_SIGNAL_CATCH: u64 = 24;
pub const SYS_SIGNAL_CHECK: u64 = 25;

// IPC
pub const SYS_IPC_OPEN:     u64 = 26;
pub const SYS_IPC_SEND:     u64 = 27;
pub const SYS_IPC_RECV:     u64 = 28;
pub const SYS_IPC_TRY_RECV: u64 = 29; // non-blocking SYS_IPC_RECV (returns immediately if empty)
pub const SYS_IPC_CLOSE:    u64 = 30;

// File I/O
pub const SYS_OPEN:     u64 = 31;
pub const SYS_CLOSE:    u64 = 32;
pub const SYS_READ:     u64 = 33;
pub const SYS_TRY_READ: u64 = 34; // non-blocking SYS_READ (0 = would block, u64::MAX = EOF)
pub const SYS_WRITE:    u64 = 35;
pub const SYS_IOCTL:    u64 = 36;
pub const SYS_PIPE:     u64 = 37;

// Hardware / Driver
pub const SYS_PCI_INFO:       u64 = 38;
pub const SYS_IOPORT_REQUEST: u64 = 39;
pub const SYS_IRQ_WAIT:       u64 = 40;
pub const SYS_DMA_ALLOC:      u64 = 41;
pub const SYS_DMA_FREE:       u64 = 42;

// PCI
pub const SYS_PCI_BAR_MAP:   u64 = 43;
pub const SYS_PCI_BAR_UNMAP: u64 = 44;

// Keyboard
pub const SYS_KEYBOARD_POLL: u64 = 45;

// System / Misc
pub const SYS_CPU_INFO:  u64 = 46;
pub const SYS_SHUTDOWN:  u64 = 47;
...
pub const SYS_UNLINK: u64 = 55; // delete a file
pub const SYS_MKDIR:  u64 = 56; // create a directory
pub const SYS_RMDIR:  u64 = 57; // remove an empty directory
