...
pub const SYS_PROCESS_INFO:  u64 = 15;
pub const SYS_PROCESS_NEXT:  u64 = 16;
...
// Memory
pub const SYS_MEM_INFO:   u64 = 18;
pub const SYS_HEAP_ALLOC: u64 = 19;
pub const SYS_HEAP_FREE:  u64 = 20;

// Signals
pub const SYS_SIGNAL_CATCH: u64 = 21;
pub const SYS_SIGNAL_CHECK: u64 = 22;

// IPC
pub const SYS_IPC_OPEN:     u64 = 23;
pub const SYS_IPC_SEND:     u64 = 24;
pub const SYS_IPC_RECV:     u64 = 25;
pub const SYS_IPC_TRY_RECV: u64 = 26; // non-blocking SYS_IPC_RECV (returns immediately if empty)
pub const SYS_IPC_CLOSE:    u64 = 27;

// File I/O
pub const SYS_OPEN:     u64 = 28;
pub const SYS_CLOSE:    u64 = 29;
pub const SYS_READ:     u64 = 30;
pub const SYS_TRY_READ: u64 = 31; // non-blocking SYS_READ (0 = would block, u64::MAX = EOF)
pub const SYS_WRITE:    u64 = 32;
pub const SYS_IOCTL:    u64 = 33;
pub const SYS_PIPE:     u64 = 34;

// Hardware / Driver
pub const SYS_PCI_INFO:       u64 = 35;
pub const SYS_IOPORT_REQUEST: u64 = 36;
pub const SYS_IRQ_WAIT:       u64 = 37;
pub const SYS_DMA_ALLOC:      u64 = 38;
pub const SYS_DMA_FREE:       u64 = 39;

// PCI
pub const SYS_PCI_BAR_MAP:   u64 = 40;
pub const SYS_PCI_BAR_UNMAP: u64 = 41;

// Keyboard
pub const SYS_KEYBOARD_POLL: u64 = 42;

// System / Misc
pub const SYS_CPU_INFO:  u64 = 43;
pub const SYS_SHUTDOWN:  u64 = 44;
pub const SYS_REBOOT:    u64 = 45;
pub const SYS_READDIR:   u64 = 46; // enumerate a directory into a caller buffer (no kernel-side printing)

// Kernel modules
pub const SYS_MODULE_LOAD:   u64 = 47;
pub const SYS_MODULE_UNLOAD: u64 = 48;
pub const SYS_MODULE_LIST:   u64 = 49;
pub const SYS_MODULE_INFO:   u64 = 50;

// Filesystem mutations (RAM rootfs)
pub const SYS_CREATE: u64 = 51; // create an empty file, returns fd (RW)
pub const SYS_UNLINK: u64 = 52; // delete a file
pub const SYS_MKDIR:  u64 = 53; // create a directory
pub const SYS_RMDIR:  u64 = 54; // remove an empty directory
...
pub const SYS_SIGINT_FG: u64 = 55;
